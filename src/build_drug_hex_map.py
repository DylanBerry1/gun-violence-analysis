"""
Generate Chicago drug crime visualization and reusable hex IDs.

Outputs:
- chicago_drug_hex_map.html
- data/processed/hex/chicago_drug_hex_counts.csv
- data/processed/hex/chicago_drug_with_hex.csv
- data/processed/hex/chicago_drug_hex_time_season_counts.csv
...
CSV_PATH = ROOT_DIR / "data" / "raw" / "chicago_drug_crimes.csv"
OUT_HEX_MAP = ROOT_DIR / "reports" / "maps" / "chicago_drug_hex_map.html"
CSV_OUT_DIR = ROOT_DIR / "data" / "processed" / "hex"
OUT_HEX_COUNTS = CSV_OUT_DIR / "chicago_drug_hex_counts.csv"
OUT_INCIDENTS = CSV_OUT_DIR / "chicago_drug_with_hex.csv"
OUT_TIME_SEASON = CSV_OUT_DIR / "chicago_drug_hex_time_season_counts.csv"
...
MAP_TITLE = "Chicago Drug Hex Map"
MAP_DESCRIPTION = (
    "Interactive Chicago drug crime hex map with adjustable hex size and "
    "per-hex drug crime counts."
)
    ...
    _template = Template(
        ...
        (function() {
            ...
            function buildDetailHtml(props) {
                return `<strong>Hex ID</strong>: ${props.h}<br><strong>Drug Crime Count</strong>: ${props.c}`;
            }
            ...
            const LegendControl = L.Control.extend({
                ...
                onAdd() {
                    ...
                    title.textContent = "Drug Crimes Per Occupied Hex";
